...
var Vidage = function () {
    ...
    _createClass(Vidage, [{
        ...
        value: function init() {
            ...
            console.log("initialized the video, waiting for 'canplay' event.");
        ...
        value: function handler() {
            ...
            if ((0, _featureDetect2.default)()) {
                console.log("'canplay' event: must now pause the video.")
                this.element.pause();
                ...
                console.log("'canplay' event: can now play the video.")
                if (this.options.videoRemoval) {
